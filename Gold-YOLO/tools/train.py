...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--data-path', default='./data/URPC2020.yaml', type=str, help='path of dataset')
    ...
    parser.add_argument('--batch-size', default=5, type=int, help='total batch size for all GPUs')
